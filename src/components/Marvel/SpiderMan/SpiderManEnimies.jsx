...
function NavigationMenu() {
  ...
  return (
    <nav style={navStyle}>
      <button onClick={() => navigate('/spidermanfamily')}>Family</button>
      <button onClick={() => navigate('/spidermanalies')}>Allies</button>
      <button onClick={() => navigate('/spidermanenimies')}>Enemies</button>
    </nav>
  );
}
