...
function IronManEnimies() {
  const enemies = [
    'Mandarin', 'Obadiah Stane', 'Justin Hammer',
    'Whiplash', 'Crimson Dynamo', 'Titanium Man',
    'Ultron', 'Modok', 'Hydra',
    'Killian', 'Aldrich Killian', 'Spymaster',
  ];

  return (
    <>
      <div style={headerStyle}>
        <h2 style={{ margin: 0 }}>Iron Man Enemies</h2>
        <NavigationMenu />
      </div>
