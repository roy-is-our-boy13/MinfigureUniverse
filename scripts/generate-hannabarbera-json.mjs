/**
 * Extract allies/enemies from HannaBarbera *Alies.jsx / *Enimies.jsx, write src/data/hannabarbera/*.json,
 * and update components to use CharacterPhotoGrid items={...}.
 * Run: node scripts/generate-hannabarbera-json.mjs
 */
import fs from 'fs';
...
const franchiseRoot = path.join(root, 'src', 'components', 'HannaBarbera');
const dataSlug = 'hannabarbera';
