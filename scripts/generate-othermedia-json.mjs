/**
 * Extract allies/enemies from OtherMedia *Alies.jsx / *Enimies.jsx, write src/data/othermedia/*.json,
 * and update components to use CharacterPhotoGrid items={...}.
 * Run: node scripts/generate-othermedia-json.mjs
 */
import fs from 'fs';
...
const franchiseRoot = path.join(root, 'src', 'components', 'OtherMedia');
const dataSlug = 'othermedia';
