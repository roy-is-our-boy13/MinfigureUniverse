/**
 * Extract allies/enemies from Dynamite *Alies.jsx / *Enimies.jsx, write src/data/dynamite/*.json,
 * and update components to use CharacterPhotoGrid items={...}.
 * Run: node scripts/generate-dynamite-json.mjs
 */
import fs from 'fs';
...
const franchiseRoot = path.join(root, 'src', 'components', 'Dynamite');
const dataSlug = 'dynamite';
