/**
 * Extract allies/enemies from Toei *Alies.jsx / *Enimies.jsx, write src/data/toei/*.json,
 * and update components to use CharacterPhotoGrid items={...}.
 * Run: node scripts/generate-toei-json.mjs
 */
import fs from 'fs';
...
const franchiseRoot = path.join(root, 'src', 'components', 'Toei');
const dataSlug = 'toei';
